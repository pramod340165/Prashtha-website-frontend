...
function createScroller(config) {
  ...
  return attachScrollEvent(options).pipe((0, import_operators3.mergeMap)(() => (0, import_rxjs3.of)(calculatePoints(element, resolver))), (0, import_operators3.map)((positionStats) => toInfiniteScrollParams(scrollState.lastScrollPosition, positionStats, distance)), (0, import_operators3.tap)(({
    stats
...
function attachScrollEvent(options) {
  let obs = (0, import_rxjs3.fromEvent)(options.container, "scroll");
  if (options.throttle) {
