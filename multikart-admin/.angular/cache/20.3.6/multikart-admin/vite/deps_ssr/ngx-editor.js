...
function insertInto2(content, dist, insert, parent) {
  ...
  let inner = insertInto2(child.content, dist - offset2 - 1, insert, child);
  return inner && content.replaceChild(index, child.copy(inner));
}
...
var _MenuService = class _MenuService {
  constructor() {
    this.customMenuRefChange = new import_rxjs.Subject();
  }
  setCustomMenuRef(c) {
...
var Editor = class {
  constructor(options = DEFAULT_OPTIONS) {
    this.valueChangesSubject = new import_rxjs.Subject();
    this.updateSubject = new import_rxjs.Subject();
