...
@Component({
  ...
  templateUrl: './product-three-column-thumbnail-bottom.html',
  styleUrl: './product-three-column-thumbnail-bottom.scss',
})
export class ProductThreeColumnThumbnailBottom {
